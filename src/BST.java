...
public class BST<T> {
	 ...
	 * 
	 * @param bst  the BST of which to make a copy.
	 * @param c    the way the tree is organized public BST(BST<T> bst,
	 *             Comparator<T> c) { copyHelper(bst.root, c); }
	 * 
	...
	public T getRoot() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("getRoot(): BST is empty. Cannot get the root.");
		}
		return root.data;
	}
	...
	public T findMin() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("findMin(): BST is empty. Cannot find the smallest value.");
		} else {
			return findMin(root);
		}
	}
	...
	public T findMax() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("findMax(): BST is empty. Cannot find the largest value.");
		} else {
			return findMax(root);
		}
	}
